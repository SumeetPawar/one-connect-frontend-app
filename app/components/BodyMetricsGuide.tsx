...
/*
  BODY METRICS GUIDE — v3
  ────────────────────────────────────────────────────────────────
  Design direction: Withings × Samsung Health × Whoop editorial.

  Core principle: Typography IS the icon.
  Large unit abbreviations (%, kg, lvl, kcal) serve as the visual
  anchor for each metric — this is how premium health instruments
  signal maturity. No icon tiles. No playful graphics.

  Visual hierarchy per row:
    1. Coloured unit glyph (DM Serif Display) — attention anchor
    2. Metric name (DM Sans 600) — identity
    3. Tagline (DM Sans 300) — context
    4. Category dot + label — taxonomy

  Detail sheet hierarchy:
    Large serif unit → overline category → bold label → italic tagline
    → section overlines (9px caps) → body (DM Sans 300, 1.78 line-height)

  Color: functional only. Each metric has one accent. Used on unit
  glyph, rule, section tint. Never decorative.
  ────────────────────────────────────────────────────────────────
*/
...
const GUIDES: MetricGuide[] = [
  ...
  },
  {
    ...
    idealMale: "18–24% (age 30–39)",
    idealFemale: "25–31% (age 30–39)",
    unit: "%",
  ...
  },
  {
    ...
    idealMale: "SMI ≥ 8.87 kg/m² (adjusted for your height)",
    idealFemale: "SMI ≥ 6.42 kg/m² (adjusted for your height)",
    unit: "kg",
  ...
  },
  {
    ...
    how: "We calculate this from your weight, height, age, and sex using a well-established formula. Some smart scales also estimate it directly from your body composition.",
    idealMale: "1,600–2,000 kcal (depends on your size and age)",
    idealFemale: "1,400–1,800 kcal (depends on your size and age)",
    unit: "kcal",
  ...
  },
  {
    ...
    idealMale: "Same as or lower than your actual age",
    idealFemale: "Same as or lower than your actual age",
    unit: "yrs",
  ...
  },
  {
    ...
    idealMale: "3.0–3.8 kg (under 40)",
    idealFemale: "2.0–2.8 kg (under 40)",
    unit: "kg",
  ...
  return (
    <>
      <style>{`
        ...
        .bmg-sheet {
          animation: sheet-rise 0.44s cubic-bezier(0.22,1,0.36,1) both;
        }
      ...
      <div className="bmg" style={{
        ...
        <div style={{
          ...
          <div style={{ flexShrink: 0, padding: "52px 22px 0", background: "#0D0D0F" }}>
              ...
              {onClose && (
                <button onClick={onClose} style={{
                  ...
                  <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
                    <path d="M1 1l8 8M9 1L1 9" stroke="rgba(255,255,255,0.45)"
            ...
            {/* Filter pills */}
            <div className="bmg-scroll" style={{
              display: "flex", gap: 6, overflowX: "auto",
              paddingBottom: 16, marginRight: -22, paddingRight: 22,
            }}>
              {([null, ...CATEGORIES] as (string | null)[]).map(cat => {
                const active = activeCategory === cat;
                return (
                  <button key={cat ?? "all"} className="bmg-pill"
          ...
          <div className="bmg-scroll" style={{ overflowY: "auto", flex: 1 }}>
              ...
              >
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    fontWeight: 400, color: g.color,
                    lineHeight: 1, letterSpacing: "-0.02em",
                  }}>{g.abbr}</div>
                  <div style={{
                    width: 16, height: 1.5, borderRadius: 100,
                    background: g.color, opacity: 0.30,
                  }}/>
                </div>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{
                    ...
                    color: "rgba(255,255,255,0.88)", marginBottom: 3, lineHeight: 1.15,
                  }}>{g.label}</div>
                  <div style={{
                ...
                <div style={{
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                    <div style={{
                      ...
                      background: CAT_COLOR[g.category], opacity: 0.55,
                    }}/>
                    <span style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                color: "rgba(255,255,255,0.16)", lineHeight: 1.75,
                letterSpacing: "-0.01em",
              }}>
          ...
          <>
            ...
            <div className="bmg-sheet" style={{
              ...
              <div onClick={() => setSelected(null)} style={{
                ...
                padding: "12px 0 0", cursor: "pointer", flexShrink: 0,
              }}>
                <div style={{
              ...
              <div style={{ padding: "14px 22px 18px", flexShrink: 0 }}>
                ...
                <div style={{ display: "flex", alignItems: "flex-end", gap: 14, marginBottom: 6 }}>
                  ...
                  <div style={{ paddingBottom: 5 }}>
                    <div style={{
                      ...
                      color: `${CAT_COLOR[selected.category]}80`,
                ...
                <div style={{
                  ...
                  marginBottom: 16,
                }}>{selected.tagline}</div>

                {/* Accent rule */}
                <div style={{
                  height: 1, borderRadius: 100,
                  background: `linear-gradient(90deg, ${selected.color}88 0%, transparent 60%)`,
                }}/>
              </div>

              {/* Scrollable content */}
              <div className="bmg-scroll" style={{
                overflowY: "auto", flex: 1, padding: "4px 0 64px",
              }}>

                <Block label="What is it">
                  <Body>{selected.what}</Body>
                </Block>

                <Block label="Why it matters">
                  <Body>{selected.why}</Body>
                </Block>

                <Block label="How it's measured">
                  <Body>{selected.how}</Body>
                </Block>
                    ...
                    {[
                      ...
                      <div key={row.label} style={{
                        ...
                        <div style={{
                          ...
                          flexShrink: 0, minWidth: 44, paddingTop: 2, opacity: 0.85,
                        }}>{row.label}</div>
                        <div style={{
                ...
                <div style={{ padding: "0 22px" }}>
                  <div style={{
                    ...
                    border: `1px solid ${selected.color}12`,
...
function Body({ children }: { children: React.ReactNode }) {
  return (
    <p style={{
      margin: 0, fontSize: 13.5, fontWeight: 300,
